...
app.get('/Enreap', function(request, response) {
    ...
    response.write("<h2><center>Welcome to  Enreap. Please Contact +91-9980923226  +91-9980923216 +91-9014996877 for more information or send an email to devopstrainingblr@gmail.com <center></h2>" );
    response.end();
  ...
  app.get('/docker', function(request, response) {
    ...
    response.write("<h2><center>Welcome to  Enreap. Please Contact and visit https://enreap.com/  <center></h2>" );
    response.end();
...
app.get("/html", function(req,res){
    ...
    app.get("/jsonData", function(req,res){
		...
		'name': 'Enreap',
		'technology': 'DevOps',
		'contact' : 'https://enreap.com/',
		'email': 'mariyababu.dasari@enreap.com'
	            });
